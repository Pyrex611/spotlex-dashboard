  ...
  return (
    <div className="max-w-3xl mx-auto bg-white p-6 md:p-12 rounded-[2rem] md:rounded-[2.5rem] shadow-lg border border-green-100 animate-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 bg-white p-5 md:p-6 rounded-2xl md:rounded-3xl border-2 border-dashed border-green-200">
            ...
            <div className="flex-1 text-center sm:text-left">
              <label className="bg-green-50 border-2 border-green-200 text-green-800 px-6 py-3 rounded-xl font-bold cursor-pointer hover:bg-green-100 transition-colors inline-block shadow-sm">
                Choose Image
        ...
        <button type="submit" disabled={isSubmitting} className="w-full bg-green-800 text-white py-4 md:py-5 rounded-2xl font-black text-lg md:text-xl hover:bg-green-900 shadow-xl transition-all disabled:opacity-50 mt-6 active:scale-[0.98]">
