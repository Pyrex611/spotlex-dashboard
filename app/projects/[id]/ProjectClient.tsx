      ...
      <div className="bg-white p-6 md:p-12 rounded-[2rem] md:rounded-[2.5rem] shadow-lg border border-green-100">
        ...
        {project.status === 'ONGOING' && (
          <div className="mt-8 md:mt-12 border-t-2 border-green-50 pt-8 md:pt-10 flex flex-col md:flex-row justify-end">
            <button type="button" onClick={handleEndInitiate} className="w-full md:w-auto bg-red-50 text-red-600 hover:bg-red-600 hover:text-white border-2 border-red-200 hover:border-red-600 px-10 py-4 rounded-xl md:rounded-2xl font-black text-lg transition-all shadow-sm active:scale-95">
              End Project
            </button>
          </div>
        )}
